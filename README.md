...
- **UIコンポーネント**: 
  - アップロード進捗モーダル
  - 4段階アラートシステム (Info/Warning/Success/Danger)
  - レスポンシブレイアウト (2カラム→1カラム)
...
これにより、バックエンド（ポート8000）とフロントエンド（ポート5173）が自動的に起動します。
...
├─────────────────────────────────────────────────────────────┤
│ ℹ️ An informational alert      ❌   ⚠️ A warning alert    ❌ │
│                                                            │
│ ℹ️ An informational alert      ❌   ⚠️ A warning alert    ❌ │
│   Button                           Button                  │
│                                                            │
│ ℹ️ An informational alert      ❌   ⚠️ A warning alert    ❌ │
│   This description provides         This description        │
│   context to the user...           provides context...     │
│   Button                           Button                  │
└─────────────────────────────────────────────────────────────┘
...
│ 🟢 Success                         🔴 Danger               │
├─────────────────────────────────────────────────────────────┤
│ ✅ A successful alert          ❌   ❌ A Danger alert      ❌ │
│                                                            │
│ ✅ A successful alert          ❌   ❌ A Danger alert      ❌ │
│   Button                           Button                  │
│                                                            │
...
**UI要素詳細:**
- **Informational (情報)**: 青色背景、ℹ️アイコン、軽微な推奨事項
- **Warning (警告)**: 黄色背景、⚠️アイコン、注意が必要な問題
- **Success (成功)**: 緑色背景、✅アイコン、適切に設定済みの項目
- **Danger (危険)**: 赤色背景、❌アイコン、重大なセキュリティ問題

**共通要素:**
- **閉じるボタン**: 各アラート右上に❌ボタン
- **アクションボタン**: 必要に応じて青色の「Button」リンク
- **説明文**: 詳細な問題説明と修正方法
- **レスポンシブ**: 2カラムレイアウト（モバイルでは1カラム）
